  ...
  return (
    <div className="rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-6 shadow-sm transition-all duration-300">
      <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
        <div
          className={`transition-all duration-500 ${showAnimation ? "translate-x-0 opacity-100" : "-translate-x-4 opacity-0"}`}
        >
        ...
        <div
          className={`transition-all duration-500 delay-150 ${showAnimation ? "translate-y-0 opacity-100" : "translate-y-4 opacity-0"}`}
        >
