...
export default function FooterSection() {
  ...
  return (
    <footer className="border-b mt-12 bg-white dark:bg-transparent">
      <div className="mb-8 border-b md:mb-12">
        <div className="mx-auto flex max-w-5xl flex-wrap items-center justify-between gap-6 px-6 pb-6">
            ...
            <div className="relative">
              ...
              <select
                className={cn(
                  ...
                  "aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:bg-black dark:text-white"
                )}
                name="language"
              >
